...
//rtc
#define RTC_INTP 	(*(volatile unsigned long *) 0xe2800030)
...
#define CURTICCNT 	(*(volatile unsigned long *) 0xe2800040)
...
#define BCDWEEK 	(*(volatile unsigned long *) 0xe2800080)
...
//the address of vector interrupt: 0xD0037400~0xD0037420
