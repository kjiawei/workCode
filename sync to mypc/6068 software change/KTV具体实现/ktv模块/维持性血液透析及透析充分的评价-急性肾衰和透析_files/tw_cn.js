...
//	if(chgTxt) txt	=txt.replace ( (  ), (toFT ? "·±" : "¼ò" ));
...
//Õâ¸öº¯Êý¹©±»¶¯µ÷ÓÃ£¬ÏóÍ¨¹ýonclick°ÑÄ³¸öspanµÄid´æ½øÈ¥£¬Àý×Ó£ºartdetailsÖÐµÄ°´·±Ìå¼ü
function doStranLink(objname){
	obj	=document.getElementById(objname);
	return doStranLinkObj(obj);
	}
//Õâ¸öº¯ÊýºÍÉÏÒ»¸ö´óÍ¬Ð¡Òì£¬Çø±ð½öÔÚÓÚÊ¹ÓÃµÄ²»ÊÇ¶ÔÏóÃû£¬¶øÊÇÖ±½ÓÒÑ¾­È¡³öÀ´µÄ¶ÔÏó	
...
//Õâ¸ö¹ý³Ì×Ô¶¯Ñ­»·¿´¿´ÓÐÃ»ÓÐidÊÇStranLink0µ½StrankLink100µÄ¶ÔÏó£¬£¨¼´´øidµÄ<span><div> Ö®Àà£¬idÊÇStranLinkxxx)£¬ÓÐ¾Í°ÑÀïÃæµÄÎÄ×Ö×ª³É·±Ìå¡£Èç¹ûÖÐ¼ä³öÏÖ¶Ïµµ£¬¾Í»áÖÐÖ¹£¬²»»áÔÙÊÔ£¬Àý×Ó£ºtest/testtwch.jsp
